...
%%
    ...
    public PilaTercetos getPilaTercetos() {
        return pilaTercetos;
    }
    ...
    public void exec() {
        ...
        while (this.pilaTercetosCHECK.getContador() > 0) {
            this.pilaTercetos.apilar(this.pilaTercetosCHECK.pop());
        }

        this.pilaTercetos.print();
    }
    ...
    public List<String> errores_lexicos;
    public List<String> errores_sintacticos;
    public List<String> errores_semanticos;
    public List<String> estructuras;

    public Parser(LexicalAnalyzer lexicalAnalyzer, SymbolTable st) {
        this(lexicalAnalyzer, st, new ArrayList<>(), new ArrayList<>(), new ArrayList<>());
    }

    public Parser(LexicalAnalyzer lexicalAnalyzer, SymbolTable st, List<String> erroresSintacticos, List<String> erroresSemanticos, List<String> estructuras) {
        this.lexicalAnalyzer = lexicalAnalyzer;
        this.st = st;
        this.pilaTercetos = new PilaTercetos();
        this.pilaTercetosCHECK = new PilaTercetos();
        this.declarandoInstancia = false;
        this.errores_sintacticos = erroresSintacticos;
        this.errores_semanticos = erroresSemanticos;
